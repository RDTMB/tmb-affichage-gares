...
--        and p.proname <> 'definir_acces';
--     -> 0 ligne attendue.
--
--     `definir_acces` (12/09/2026, docs/01 §2.12) est la SEULE dérogation, et
--     elle est délibérée : seules les fonctions de `public` sont exposées en
--     RPC par PostgREST, et cette écriture DOIT l'être — c'est la seule voie
--     par laquelle `admin`, qui n'a aucune politique RLS sur une circulation
